// Comprehensive list of Indian districts/cities for the location picker (UI config, not marketplace content).
// Grouped by state/UT for maintainability; the exported list is deduplicated and sorted alphabetically.
...
const DISTRICTS_BY_STATE: Record<string, string[]> = {
  "Andhra Pradesh": [
    ...
    "NTR", "Guntur", "Palnadu", "Bapatla", "Prakasam", "Nellore", "Kurnool", "Nandyal", "Anantapur",
    "Sri Sathya Sai", "YSR Kadapa", "Annamayya", "Chittoor", "Tirupati",
  ],
  "Arunachal Pradesh": [
    "Tawang", "West Kameng", "East Kameng", "Papum Pare", "Kurung Kumey", "Kra Daadi",
    "Lower Subansiri", "Upper Subansiri", "West Siang", "Lepa Rada", "East Siang", "Siang",
    "Upper Siang", "Lower Siang", "Lower Dibang Valley", "Dibang Valley", "Anjaw", "Lohit",
    "Namsai", "Changlang", "Tirap", "Longding", "Kamle", "Shi Yomi", "Pakke-Kessang",
  ],
  Assam: [
    "Kokrajhar", "Bongaigaon", "Chirang", "Dhubri", "South Salmara-Mankachar", "Goalpara",
    "Barpeta", "Baksa", "Nalbari", "Bajali", "Kamrup", "Kamrup Metropolitan", "Darrang",
    "Udalguri", "Sonitpur", "Biswanath", "Charaideo", "Sivasagar", "Jorhat", "Majuli", "Golaghat",
    "Dibrugarh", "Tinsukia", "Dhemaji", "Lakhimpur", "Karbi Anglong", "West Karbi Anglong",
    "Dima Hasao", "Cachar", "Karimganj", "Hailakandi", "Nagaon", "Hojai", "Morigaon",
  ],
  Bihar: [
    "Patna", "Nalanda", "Bhojpur", "Buxar", "Kaimur", "Rohtas", "Arwal", "Jehanabad", "Aurangabad",
    "Gaya", "Nawada", "Sheikhpura", "Lakhisarai", "Munger", "Jamui", "Banka", "Bhagalpur",
    "Khagaria", "Begusarai", "Samastipur", "Darbhanga", "Madhubani", "Sitamarhi", "Sheohar",
    "Muzaffarpur", "Vaishali", "Saran", "Siwan", "Gopalganj", "East Champaran", "West Champaran",
    "Purnia", "Katihar", "Araria", "Kishanganj", "Saharsa", "Supaul", "Madhepura",
  ],
  Chhattisgarh: [
    "Raipur", "Balodabazar", "Mahasamund", "Gariaband", "Dhamtari", "Balod", "Bemetara",
    "Kabirdham", "Rajnandgaon", "Mohla-Manpur-Ambagarh Chowki", "Khairagarh-Chhuikhadan-Gandai",
    "Durg", "Kondagaon", "Bastar", "Jagdalpur", "Dantewada", "Sukma", "Bijapur", "Narayanpur",
    "Kanker", "Korba", "Janjgir-Champa", "Bilaspur", "Mungeli", "Gaurela-Pendra-Marwahi",
    "Raigarh", "Jashpur", "Surajpur", "Surguja", "Balrampur", "Koriya",
  ...
  Karnataka: [
    "Bagalkot", "Ballari", "Belagavi", "Bengaluru Rural", "Bengaluru Urban", "Bengaluru", "Bidar",
  ...
  Kerala: [
    "Alappuzha", "Ernakulam", "Idukki", "Kannur", "Kasaragod", "Kochi", "Kollam", "Kottayam",
  ...
  "Madhya Pradesh": [
    ...
    "Katni", "Khandwa", "Khargone", "Mandla", "Mandsaur", "Maihar", "Mauganj", "Morena",
  ...
  Meghalaya: [
    ...
    "West Jaintia Hills", "West Khasi Hills", "Shillong",
  ],
  Mizoram: [
  ...
  Punjab: [
    ...
    "Moga", "Sri Muktsar Sahib", "Pathankot", "Patiala", "Rupnagar", "Sangrur",
    "Shaheed Bhagat Singh Nagar", "Tarn Taran", "Mohali",
  ],
  Rajasthan: [
  ...
  Sikkim: ["East Sikkim", "North Sikkim", "South Sikkim", "West Sikkim", "Pakyong", "Soreng", "Gangtok"],
  "Tamil Nadu": [
  ...
  "Uttar Pradesh": [
    ...
    "Mau", "Meerut", "Mirzapur", "Moradabad", "Muzaffarnagar", "Noida", "Pilibhit", "Pratapgarh",
  ...
  "Andaman and Nicobar Islands": ["North and Middle Andaman", "South Andaman", "Nicobar", "Port Blair"],
...
const ALL_LOCATIONS = Array.from(new Set(Object.values(DISTRICTS_BY_STATE).flat())).sort((a, b) =>
  a.localeCompare(b)
);
