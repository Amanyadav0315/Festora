...
export default async function ListingDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <main className="mx-auto max-w-6xl px-4 py-6 sm:py-8">
      {/* Mobile/tablet: single stacked column (unchanged below lg). Desktop: gallery left,
          details in a sticky right rail so the page uses the available width instead of
          floating a narrow column in the middle of the screen. */}
      <div className="lg:grid lg:grid-cols-[1.3fr_1fr] lg:items-start lg:gap-8">
        <ImageCarousel
          images={listing.images}
          alt={listing.title}
          aspect="aspect-[4/3] max-h-[420px] lg:max-h-[520px]"
          showThumbnails
        />

        <div className="lg:sticky lg:top-20">
          <div className="mt-3 flex flex-wrap items-center gap-2 text-xs lg:mt-0">
